...
public interface WebServices {
     ...
     */
    @WebMethod
    @Action(input = "http://ws.volando.uy/WebServices/registrarVueloRequest", output = "http://ws.volando.uy/WebServices/registrarVueloResponse")
    public void registrarVuelo(
        @WebParam(name = "nicknameAerolinea", partName = "nicknameAerolinea")
        String nicknameAerolinea,
        @WebParam(name = "nombreRuta", partName = "nombreRuta")
        String nombreRuta,
        @WebParam(name = "arg2", partName = "arg2")
        DataVueloEspecifico arg2);
