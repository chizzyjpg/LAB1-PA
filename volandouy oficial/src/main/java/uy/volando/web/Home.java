...
/**
 * Servlet principal para la página de inicio de la aplicación VolandoUy.
 * Gestiona el estado de la sesión y 
 * redirige a las vistas correspondientes según el estado de login.
