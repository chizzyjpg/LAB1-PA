...
/**
 * JInternalFrame para consultar vuelos y sus reservas.
 */
public class ConsultaVuelo extends JInternalFrame {
  ...
  /**
   * Constructor sin argumentos para WindowBuilder (no usar).
   */
  ...
  private void armarUI() {
    ...
    JLabel labelVuelos = new JLabel("Vuelos asociados a la ruta");
    labelVuelos.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    left.add(labelVuelos, BorderLayout.NORTH);
    ...
    JLabel labelDetalleVuelo = new JLabel("Detalle del vuelo");
    labelDetalleVuelo.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    detallePanel.add(labelDetalleVuelo, BorderLayout.NORTH);
    ...
    JLabel labelReservas = new JLabel("Reservas asociadas");
    labelReservas.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    reservasPanel.add(labelReservas, BorderLayout.NORTH);
  ...
  /**
   * Carga las aerolíneas en el combo correspondiente.
   */
  ...
  /**
   * Carga las rutas asociadas a la aerolínea seleccionada.
   */
  ...
  /**
   * Carga los vuelos asociados a la ruta seleccionada.
   */
  ...
  /**
   * Muestra el detalle del vuelo seleccionado y sus reservas.
   */
  ...
  /**
   * Limpia la lista de vuelos y el área de detalle.
   */
  ...
  /**
   * Devuelve una cadena segura para mostrar errores.
   */
  ...
  /**
   * Formatea la información de un vuelo específico para mostrar.
   */
  private String formatVuelo(DataVueloEspecifico v) {
    ...
    return """
        ...
        Fecha alta: %s
        """.formatted(errorSafe(v.getNombre()), fVuelo, v.getDuracion(), v.getMaxAsientosTur(), v.getMaxAsientosEjec(), fAlta);
  }
