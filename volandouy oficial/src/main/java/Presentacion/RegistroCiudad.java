...
/**
 * Clase que representa la interfaz gráfica para registrar una nueva ciudad.
 */
public class RegistroCiudad extends JInternalFrame {
  ...
  public RegistroCiudad(ISistema sistema) {
    ...
    JLabel lblAeropuerto = new JLabel("Aeropuerto asociado:");
    lblAeropuerto.setFont(new Font("Comic Sans MS", Font.PLAIN, 14));
    lblAeropuerto.setBounds(10, 97, 138, 19);
    getContentPane().add(lblAeropuerto);
