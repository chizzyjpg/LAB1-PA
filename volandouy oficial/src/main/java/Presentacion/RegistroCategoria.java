...
/**
 * Clase que representa la interfaz gráfica para registrar una nueva categoría.
 */
public class RegistroCategoria extends JInternalFrame {
  ...
  /**
   * Crea una nueva instancia de la ventana de registro de categoría.
   *
   * 
   */
  public RegistroCategoria(ISistema sistema) {
    ...
    btnAceptar.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (cat.isEmpty()) {
          JOptionPane.showMessageDialog(RegistroCategoria.this, "La Categoría NO puede estar vacía",
              "Error Categoría", JOptionPane.ERROR_MESSAGE);
        ...
        try {
          ...
          JOptionPane.showMessageDialog(RegistroCategoria.this, ex.getMessage(), "Validación",
              JOptionPane.ERROR_MESSAGE);
          textFieldCategoria.requestFocusInWindow();
          textFieldCategoria.selectAll();
        } catch (Exception ex) {
          JOptionPane.showMessageDialog(RegistroCategoria.this,
              "Error al registrar la categoría: " + ex.getMessage(), "Error",
              JOptionPane.ERROR_MESSAGE);
        }
