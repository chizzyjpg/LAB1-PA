...
/**
 * Interfaz gráfica para la reserva de vuelos.
 */
public class ReservaVuelo extends JInternalFrame {
  ...
  public ReservaVuelo(ISistema sistema) {
    ...
    JComboBox comboBoxVuelos = new JComboBox();
    comboBoxVuelos.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    comboBoxVuelos.setBounds(186, 91, 166, 22);
    getContentPane().add(comboBoxVuelos);

    JComboBox comboBoxCliente = new JComboBox();
    comboBoxCliente.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    comboBoxCliente.setBounds(186, 123, 166, 22);
    ...
    spinner2.setBounds(186, 227, 43, 20);
