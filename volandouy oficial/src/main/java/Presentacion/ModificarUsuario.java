...
/**
 * Interfaz gráfica para modificar la información de un usuario existente.
 */
public class ModificarUsuario extends JInternalFrame {
  ...
  /**
   * Constructor de la interfaz de modificación de usuario.
   * 
   * 
   */
  ...
  private void initUI() {
    ...
    labelNickname.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    formCommon.add(labelNickname);
    formCommon.add(txtNick);
    JLabel labelEmail = new JLabel("Email:");
    labelEmail.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    formCommon.add(labelEmail);
    formCommon.add(txtEmail);
    JLabel labelNombre = new JLabel("Nombre:");
    labelNombre.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    formCommon.add(labelNombre);
    ...
    labelDescripcion.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    pnlAero.add(labelDescripcion, c);
    ...
    labelSitioWeb.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
    pnlAero.add(labelSitioWeb, c);
