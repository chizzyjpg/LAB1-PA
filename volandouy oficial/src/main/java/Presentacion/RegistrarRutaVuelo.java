...
/**
 * Ventana para registrar una nueva ruta de vuelo en el sistema.
 * Permite ingresar datos como aerolínea, nombre, descripción, costos, ciudades, fecha y categoría.
 */
public class RegistrarRutaVuelo extends JInternalFrame {
  ...
  public RegistrarRutaVuelo(ISistema sistema) {
    ...
    JSpinner spinnerHora = new JSpinner(
        new SpinnerDateModel(new Date(1755715138092L), null, null, Calendar.DAY_OF_MONTH));
    ...
    btnAceptar.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (nombre.isEmpty()) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this, "El Nombre NO puede estar vacío",
              "Error Nombre", JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (descripcion.isEmpty()) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "La Descripción NO puede estar vacía", "Error Descripción",
              JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (descCorta.isEmpty()) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "La Descripción Corta NO puede estar vacía", "Error Descripción Corta",
              JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (turista.isEmpty()) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "El Costo Turista NO puede estar vacío", "Error Costo", JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (ejecutivo.isEmpty()) {
          /* por ahora no lo usamos, pero dejo tu check */ JOptionPane.showMessageDialog(
              RegistrarRutaVuelo.this, "El Costo Ejecutivo NO puede estar vacío", "Error Costo",
              JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (costo.isEmpty()) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "El Costo de Equipaje NO puede estar vacío", "Error Costo",
              JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (dataCiudadO == null) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "La Ciudad Origen NO puede estar vacía", "Error Ciudad Origen",
              JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (dataCiudadD == null) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "La Ciudad Destino NO puede estar vacía", "Error Ciudad Destino",
              JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (fecha == null) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this, "La Fecha NO puede estar vacía",
              "Error Fecha", JOptionPane.ERROR_MESSAGE);
          return;
        }
        if (dataCat == null) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "La Categoría NO puede estar vacía", "Error Categoría", JOptionPane.ERROR_MESSAGE);
          return;
        }
        ...
        try {
          ...
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this, "Costos deben ser números enteros",
              "Error de formato", JOptionPane.ERROR_MESSAGE);
          return;
        }

        // Hora (tomamos HH:mm del spinner → a int HHmm o solo hora; tu entidad usa 'int
        // hora')
        ...
        try {
          ...
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "Ruta de Vuelo registrada correctamente!\nNombre: " + nombre, "ÉXITO!",
          ...
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this, ex2.getMessage(), "Error",
              JOptionPane.ERROR_MESSAGE);
        } catch (Exception ex) {
          JOptionPane.showMessageDialog(RegistrarRutaVuelo.this,
              "Error al registrar ruta: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
      }
    });
