...
public class UsuarioService {
  ...
  /**
   * Lista todos los usuarios en la base de datos y los convierte a DataUsuario.
   * 
   */
  ...
  /**
   * Lista todas las rutas asociadas a una aerolínea específica.
   * 
   */
  ...
  // ===============================
  /**
   * Recupera la información de un usuario por su nickname y la convierte a DataUsuario.
   * 
   */
  ...
  /**
   * Verifica si un cliente ya ha comprado un paquete específico.
   * 
   */
  ...
  /**
   * Lista los vuelos específicos asociados a una ruta de una aerolínea.
   * 
   */
  ...
  public Usuario autenticarUsuario(String login, String password) {
    ...
    try {
      ...
      Usuario u = usuarios.get(0);
      // En un sistema real, la contraseña debería estar hasheada y se compararía el
      // hash
