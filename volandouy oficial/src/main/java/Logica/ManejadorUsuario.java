...
/**
 * Manejador para la conversión entre DataUsuario y Usuario, así como la lógica
 * asociada a la creación de usuarios.
 */
public final class ManejadorUsuario {
  ...
  /**
   * Convierte un DataUsuario a su entidad Usuario correspondiente.
   * 
   */
  ...
  // =========================
  /**
   * Convierte una entidad Usuario a su DataUsuario correspondiente.
   * 
   */
  ...
  // =========================
  /**
   * Convierte una lista de DataUsuario a una lista de entidades Usuario.
   * 
   */
  ...
  /**
   * Convierte una lista de entidades Usuario a una lista de DataUsuario.
   * 
   */
