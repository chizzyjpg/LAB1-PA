...
public interface ISistema {
  ...
  DataUsuario loguearUsuario(String nickname, String password); // null si no existe o password
                                                                // incorrecta
  ...
  void agregarRutaAPaquete(String nombrePaquete, String nicknameAerolinea, String nombreRuta,
