...
public class RegistroUsuario extends JFrame {
	...
	public RegistroUsuario() {
		...
		JRadioButton rdbtnAerolinea = new JRadioButton("Aerolínea");
		...
		textFieldFechaNacimiento.setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
		textFieldFechaNacimiento.setColumns(10);
		panelCliente.add(textFieldFechaNacimiento, "cell 1 1,growx");
		...
		btnGuardar.addActionListener(e -> {
		    ...
		    if (rdbtnCliente.isSelected()) {
		        ...
		        //String fecha    = textFieldFechaNac.getText().trim();
		        String nac      = textFieldNacionalidad.getText().trim();
		        //String tdoc     = comboBox.getText().trim();
